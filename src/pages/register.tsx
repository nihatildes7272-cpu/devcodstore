    ...
    <main className="flex min-h-screen items-center justify-center bg-[#070A12] px-6 text-white">
      <section className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl">
        ...
        <div className="grid gap-4">
          ...
          <select className="rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-white outline-none">
            <option>Alıcı hesabı</option>
            <option>Satıcı hesabı</option>
          </select>

          <button className="mt-2 rounded-2xl bg-blue-600 px-5 py-3 font-semibold hover:bg-blue-500">
            Kayıt Ol
          </button>
        </div>
